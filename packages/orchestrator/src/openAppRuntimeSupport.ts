 ...
 *  - client: MJExplorer `app.module.ts` imports the generated `open-app-bootstrap.generated.ts`.
 *
...
/** The generated client bootstrap is imported by app.module only in fixed MJ. */
const CLIENT_BOOTSTRAP_MARKER = 'open-app-bootstrap';
